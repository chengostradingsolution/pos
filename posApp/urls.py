...
urlpatterns = [
    ...
    path('addproductpos/<int:id>/', views.addproductpos, name="addproductpos"),
    path('deleteproductpos/<int:id>/', views.deleteproductpos, name="deleteproductpos"),
    path('deleteproductposflash/', views.deleteproductposflash, name="deleteproductposflash"),

    
    
    path('checkpage/', views.checkpage, name="checkpage"),
    path('checkpageprocess/', views.checkpageaddcustomer, name="checkpageaddcustomer"),
    path('createsale/<int:custid>/', views.createsale, name="createsale"),
